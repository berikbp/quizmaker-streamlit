...
- Собирать эти вопросы в тест через прикольный двухшаговый мастер (сначала вводишь название/описание, потом выбираешь вопросы).
...
- Этот вебсайт не динамичен и каждый раз нужно нажимать какие-то кнопки, чтобы сайт перезагрузился и потом пожхватила данные 
